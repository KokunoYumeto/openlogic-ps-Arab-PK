...
This view contains 154 high-priority entries from the complete 397-entry decision index for `ps-Arab-PK` (`Arab`).

## TERM-SET

- Source term or sense: set
- Choice: سټ
- Why provisional: provisional Pakistan choice; Afghan attestation
...
- Please double-check: In Pakistani Pashto mathematical prose, is «سټ» the clearest conventional rendering of “set” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: تش سټ
- Why provisional: regional concept attestation
- Rationale: Use تش with سټ, matching native mathematical meaning.
- Alternatives: خالي سټ; تشه مجموعه
- Please double-check: In Pakistani Pashto mathematical prose, is «تش سټ» the clearest conventional rendering of “empty set” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د غړو له مخې برابري
- Why provisional: provisional descriptive term; unattested exact technical label
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د غړو له مخې برابري» the clearest conventional rendering of “extensionality” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: فرعي سټ
- Why provisional: regional technical attestation
- Rationale: Retain the source distinction between subset and proper subset.
- Alternatives: سب سټ; فرعي مجموعه
- Please double-check: In Pakistani Pashto mathematical prose, is «فرعي سټ» the clearest conventional rendering of “subset” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: خاص فرعي سټ
- Why provisional: provisional qualified term
...
- Please double-check: In Pakistani Pashto mathematical prose, is «خاص فرعي سټ» the clearest conventional rendering of “proper subset” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د فرعي سټونو سټ
- Why provisional: provisional descriptive term
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د فرعي سټونو سټ» the clearest conventional rendering of “power set” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: توريز تسلسل / لړۍ
- Why provisional: provisional distinction
...
- Please double-check: In Pakistani Pashto mathematical prose, is «توريز تسلسل / لړۍ» the clearest conventional rendering of “string/sequence” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: پيوستار
- Why provisional: provisional; low confidence
...
- Please double-check: In Pakistani Pashto mathematical prose, is «پيوستار» the clearest conventional rendering of “continuum” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Please double-check: In Pakistani Pashto mathematical prose, is «اتحاد» the clearest conventional rendering of “union” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Please double-check: In Pakistani Pashto mathematical prose, is «تقاطع» the clearest conventional rendering of “intersection” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Please double-check: In Pakistani Pashto mathematical prose, is «تفاضل» the clearest conventional rendering of “set difference” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: بېل
- Why provisional: provisional defined shorthand
...
- Please double-check: In Pakistani Pashto mathematical prose, is «بېل» the clearest conventional rendering of “disjoint” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: مرتبه جوړه / مرتبه څوګونې
- Why provisional: provisional technical labels
- Rationale: Wiener-Kuratowski definition and nested pair construction follow source.
- Alternatives: منظمه جوړه; ترتيبي جوړه
- Please double-check: In Pakistani Pashto mathematical prose, is «مرتبه جوړه / مرتبه څوګونې» the clearest conventional rendering of “ordered pair / tuple” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: کارتيزي حاصل ضرب
- Why provisional: provisional technical label
- Rationale: No direct concept-specific label found in inspected native pages.
- Alternatives: کارتيز ضرب; د جوړو حاصل ضرب
- Please double-check: In Pakistani Pashto mathematical prose, is «کارتيزي حاصل ضرب» the clearest conventional rendering of “Cartesian product” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: پاراډوکس / تناقض
- Why provisional: provisional distinction
- Rationale: Name phenomenon by loanword; call logical inconsistency تناقض.
- Alternatives: معما; تضاد د پاراډوکس پر ځاے
- Please double-check: In Pakistani Pashto mathematical prose, is «پاراډوکس / تناقض» the clearest conventional rendering of “paradox / contradiction” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: مابعدمنطق
- Why provisional: provisional; exact label unattested
- Rationale: Study of logical systems follows source meaning, not metaphysics.
- Alternatives: د منطق په اړه منطق; لوړ منطق
- Please double-check: In Pakistani Pashto mathematical prose, is «مابعدمنطق» the clearest conventional rendering of “metalogic” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: صوري
- Why provisional: regional prose support; sense provisional
- Rationale: Mathematical form and method, not institutional formality.
- Alternatives: شکلي; قاعده ييز
- Please double-check: In Pakistani Pashto mathematical prose, is «صوري» the clearest conventional rendering of “formal” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: منطقي عملګر / بنسټيز
- Why provisional: provisional technical labels
- Rationale: Operations discussed in native source; exact chosen labels not claimed attested.
- Alternatives: عملیه; آپريټر
- Please double-check: In Pakistani Pashto mathematical prose, is «منطقي عملګر / بنسټيز» the clearest conventional rendering of “logical operator / primitive” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د نوم اخيستنې جواز
- Why provisional: provisional descriptive wording
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د نوم اخيستنې جواز» the clearest conventional rendering of “attribution license” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: اړيکه / دوه ځاييزه اړيکه
- Why provisional: regional technical attestation; surface and arity qualifier provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «اړيکه / دوه ځاييزه اړيکه» the clearest conventional rendering of “relation / binary relation” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د عينيت اړيکه» the clearest conventional rendering of “identity relation” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: ترتيب / سخت ترتيب
- Why provisional: provisional mathematical senses
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ترتيب / سخت ترتيب» the clearest conventional rendering of “order / strict order” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: انعکاسي / متناظره / انتقالي
- Why provisional: regional property attestation; adjective adaptation provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «انعکاسي / متناظره / انتقالي» the clearest conventional rendering of “reflexive / symmetric / transitive” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: ضد متناظره / نامتناظره / نفي انعکاسي
- Why provisional: provisional qualified labels; no exact attestation
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ضد متناظره / نامتناظره / نفي انعکاسي» the clearest conventional rendering of “antisymmetric / asymmetric / irreflexive” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: تړلې اړيکه
- Why provisional: provisional defined term
...
- Please double-check: In Pakistani Pashto mathematical prose, is «تړلې اړيکه» the clearest conventional rendering of “connected relation” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د هم ارزښتۍ اړيکه / د هم ارزښتۍ ټولګے / خارج قسمت
- Why provisional: provisional technical labels
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د هم ارزښتۍ اړيکه / د هم ارزښتۍ ټولګے / خارج قسمت» the clearest conventional rendering of “equivalence relation / class / quotient” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: پريديکات
- Why provisional: regional technical loanword
...
- Please double-check: In Pakistani Pashto mathematical prose, is «پريديکات» the clearest conventional rendering of “predicate” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: ماوراءالطبيعتي عينيت / سټونو ته د راکمونې نظر
- Why provisional: provisional philosophical paraphrases
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ماوراءالطبيعتي عينيت / سټونو ته د راکمونې نظر» the clearest conventional rendering of “metaphysical identity / set-theoretic reductionism” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د باقي حساب / باقي
- Why provisional: provisional descriptive terminology
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د باقي حساب / باقي» the clearest conventional rendering of “modular arithmetic / remainder” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: مقدماتي / جزوي / خطي / کلي ترتيب
- Why provisional: regional concept attestation; exact labels provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «مقدماتي / جزوي / خطي / کلي ترتيب» the clearest conventional rendering of “preorder / partial / linear / total order” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: غځونه / پيلنۍ برخه
- Why provisional: provisional descriptive labels
...
- Please double-check: In Pakistani Pashto mathematical prose, is «غځونه / پيلنۍ برخه» the clearest conventional rendering of “extension / initial segment” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: انعکاسي / انتقالي بندښت
- Why provisional: provisional closure label
...
- Please double-check: In Pakistani Pashto mathematical prose, is «انعکاسي / انتقالي بندښت» the clearest conventional rendering of “reflexive / transitive closure” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: ګراف / څوکه / څنډه / لوری لرونکے
- Why provisional: graph loanword attested; remaining technical labels provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ګراف / څوکه / څنډه / لوری لرونکے» the clearest conventional rendering of “graph / vertex / edge / directed” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: ونه / ريښه / نيکۀ / مخکينے / ځايناستے / څانګه
- Why provisional: provisional technical use of native words
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ونه / ريښه / نيکۀ / مخکينے / ځايناستے / څانګه» the clearest conventional rendering of “tree / root / ancestor / predecessor / successor / branch” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: تر ټولو کوچنے غړے / ښۀ مرتب
- Why provisional: provisional descriptive labels
...
- Please double-check: In Pakistani Pashto mathematical prose, is «تر ټولو کوچنے غړے / ښۀ مرتب» the clearest conventional rendering of “least element / well ordered” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: معکوس / نسبي حاصل ضرب / محدودونه / تطبيق
- Why provisional: operation vocabulary attested; particular labels provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «معکوس / نسبي حاصل ضرب / محدودونه / تطبيق» the clearest conventional rendering of “inverse / relative product / restriction / application” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: مرستندويه قضيه / کمزورې مرستندويه قضيه / محاسبه کېدنه
- Why provisional: provisional descriptive labels
...
- Please double-check: In Pakistani Pashto mathematical prose, is «مرستندويه قضيه / کمزورې مرستندويه قضيه / محاسبه کېدنه» the clearest conventional rendering of “lemma / weak lemma / computability” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: تابع / نگاشت
- Why provisional: regional technical attestation for تابع; نگاشت provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «تابع / نگاشت» the clearest conventional rendering of “function / mapping” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: ننوت / ارګومېنټ / وت / قيمت
- Why provisional: regional value concept; other exact labels provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ننوت / ارګومېنټ / وت / قيمت» the clearest conventional rendering of “input / argument / output / value” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: جزوي / هرځاے تعريف شوې / تعريف شوے / تعريف نۀ شوے / مسلسل
- Why provisional: provisional exact labels
...
- Please double-check: In Pakistani Pashto mathematical prose, is «جزوي / هرځاے تعريف شوې / تعريف شوے / تعريف نۀ شوے / مسلسل» the clearest conventional rendering of “partial / total / defined / undefined / serial” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د ټاکنې بديهي اصل
- Why provisional: provisional label, no exact native attestation
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د ټاکنې بديهي اصل» the clearest conventional rendering of “Axiom of Choice” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د شمېر وړ / د شمېر نۀ وړ
- Why provisional: regional technical attestation; target negation adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د شمېر وړ / د شمېر نۀ وړ» the clearest conventional rendering of “enumerable / countable / uncountable” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: شمېرنه / لړ / په لړ کښې راوړل
- Why provisional: attested listing concept; exact enumeration noun provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «شمېرنه / لړ / په لړ کښې راوړل» the clearest conventional rendering of “enumeration / list / to enumerate” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: اندازه / همشمېره
- Why provisional: general equal-cardinality concept directly attested; chosen همشمېره adjective provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «اندازه / همشمېره» the clearest conventional rendering of “size / equinumerous” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: متناهي / نامتناهي
- Why provisional: regional mathematical senses attested; infinite surface differs
...
- Please double-check: In Pakistani Pashto mathematical prose, is «متناهي / نامتناهي» the clearest conventional rendering of “finite/infinite” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: هله او يوازې هله ... چې
- Why provisional: regional technical construction attested; edition phrasing adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «هله او يوازې هله ... چې» the clearest conventional rendering of “if and only if” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: جوړوونکې تابع
- Why provisional: regional concept and closely related label attested
...
- Please double-check: In Pakistani Pashto mathematical prose, is «جوړوونکې تابع» the clearest conventional rendering of “pairing function” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د پاسني صحيح عدد تابع
- Why provisional: provisional explicit descriptive term
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د پاسني صحيح عدد تابع» the clearest conventional rendering of “ceiling function” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: جدولي ترتيب / قطار / ستون / قطر / زيګزاګ
- Why provisional: native diagram supports concepts; exact edition labels provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «جدولي ترتيب / قطار / ستون / قطر / زيګزاګ» the clearest conventional rendering of “array / row / column / diagonal / zig-zag” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: کوډول / کوډ بېرته لوستل / کوډ
- Why provisional: pairing concept attested; exact encode/decode surfaces provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «کوډول / کوډ بېرته لوستل / کوډ» the clearest conventional rendering of “encode / decode / code” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: طاق / جفت عدد
- Why provisional: regional technical attestation; Pakistani inflection adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «طاق / جفت عدد» the clearest conventional rendering of “odd / even number” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: قاعده / توان ښودونکے / طاقت
- Why provisional: regional mathematical attestation; Pakistani spelling adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «قاعده / توان ښودونکے / طاقت» the clearest conventional rendering of “base / exponent / power” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: قطري طريقه / قطرول
- Why provisional: native diagonal-method phrase attested; compact verbal noun provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «قطري طريقه / قطرول» the clearest conventional rendering of “diagonal method / diagonalization” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: راکمونه / ... ته راکمول
- Why provisional: exact technical term not found; compositional rendering is provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «راکمونه / ... ته راکمول» the clearest conventional rendering of “reduction (transforming one enumeration problem into another)” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: طبيعي / صحيح / ناطق / غير ناطق / حقيقي عددونه
- Why provisional: regional mathematical attestation; Pakistani spelling and inflection adapted
...
- Choice: پاسنی حد / تر ټولو لږ پاسنی حد (سپريمم) / د بشپړتيا خاصيت
- Why provisional: bound and supremum concepts regionally attested; exact Pakistani compound provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «پاسنی حد / تر ټولو لږ پاسنی حد (سپريمم) / د بشپړتيا خاصيت» the clearest conventional rendering of “upper bound / least upper bound (supremum) / completeness property” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د ډېډېکېنډ پرېکون / ناتشه خاصه پيلنۍ برخه چې تر ټولو لوے غړے نۀ لري
- Why provisional: supporting bound/order concepts attested; exact cut label unattested and provisional
...
- Choice: تبادلي حلقه / مرتبه حلقه / مرتب ميدان؛ اتحادي، تبديلي او توزيعي خاصيتونه
- Why provisional: operation-law labels regionally attested; ring and field compounds provisional
...
- Choice: د کوشي لړۍ / حد / صفر ته ورنژدې کېږي / تقارب
- Why provisional: sequence, limit and convergence concepts regionally attested; Pakistani surfaces adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د کوشي لړۍ / حد / صفر ته ورنژدې کېږي / تقارب» the clearest conventional rendering of “Cauchy sequence / limit / tends to zero / convergence” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: بازګشتي تعريف / رياضي استقرا
- Why provisional: mathematical induction directly attested; recursive-definition label remains provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «بازګشتي تعريف / رياضي استقرا» the clearest conventional rendering of “recursive definition / mathematical induction” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د ډېډېکېنډ له مخې نامتناهي / د ډېډېکېنډ الجبر / تالي تابع / د تابعې له مخې بند
- Why provisional: Dedekind finiteness and successor-minimality concepts attested; algebra compound provisional
...
- Choice: آيزومورفيزم / آيزومورف
- Why provisional: regional technical label directly attested; structure-specific preservation is source-controlled
...
- Please double-check: In Pakistani Pashto mathematical prose, is «آيزومورفيزم / آيزومورف» the clearest conventional rendering of “isomorphism / isomorphic” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
  - OLP-0049; sfr; `content/sets-functions-relations/infinite/infinite.tex` source line(s) line pending; `ps-Arab-PK/content/sets-functions-relations/infinite/infinite.tex` target line(s) line pending; page: pending stable pagination in a reader containing this unit
...
- Choice: بيان
- Why provisional: regional technical attestation; Pakistani spelling adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «بيان» the clearest conventional rendering of “proposition (truth-bearing statement)” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: معنٰی پوهنه / معنايي استلزام
- Why provisional: Pakistani semantics label and regional logic concepts attested; compound adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «معنٰی پوهنه / معنايي استلزام» the clearest conventional rendering of “semantics / semantic consequence” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د رښتياوالي تابع
- Why provisional: truth-value and truth-table concepts regionally attested; exact compound provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د رښتياوالي تابع» the clearest conventional rendering of “truth function” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: بياني متغير / منطقي نښلوونکے / نفي / عطف / فصل / شرطي / دوه اړخيز شرطي / د فارمول جوړښتي لړ
- Why provisional: formation and connective concepts regionally attested; Pakistani surfaces adapted
...
- Choice: د رښتياوالي قيمت / د رښتياوالي جدول / ارزښت ټاکنه / ارزونه / صدق / تاوتولوژي / معنايي استلزام / د صدق وړ / د صدق نۀ وړ / اتفاقي
- Why provisional: core concepts regionally attested; Pakistani labels and distinctions editorially fixed
...
- Choice: يو شان ځايناستي / هممهاله ځايناستي
- Why provisional: formula-construction context attested; exact substitution compounds provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «يو شان ځايناستي / هممهاله ځايناستي» the clearest conventional rendering of “uniform substitution / simultaneous substitution” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: بديهي اصل / د بديهي اصل شېما
- Why provisional: axiom and schema concepts regionally attested; Pakistani surface adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «بديهي اصل / د بديهي اصل شېما» the clearest conventional rendering of “axiom / axiom schema” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: فارمول / اشتقاق / بياني منطق / د لومړۍ درجې منطق / بشپړتيا
- Why provisional: regional subject, formula and proof vocabulary; derivation/completeness wording provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «فارمول / اشتقاق / بياني منطق / د لومړۍ درجې منطق / بشپړتيا» the clearest conventional rendering of “formula / derivation / propositional logic / first-order logic / completeness” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: د اشتقاق نظام / اشتقاق / قضيه / د اشتقاق وړ / د استنتاج قاعده / ثبوت
- Why provisional: proof and inference concepts regionally attested; derivation label is an editorial distinction
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د اشتقاق نظام / اشتقاق / قضيه / د اشتقاق وړ / د استنتاج قاعده / ثبوت» the clearest conventional rendering of “derivation system / derivation / theorem / derivable / inference rule / proof” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: سموالے / بشپړتيا / سازګاري / ناسازګاري / اعتبار
- Why provisional: validity, contradiction and consistency concepts regionally attested; full property set adapted
...
- Please double-check: In Pakistani Pashto mathematical prose, is «سموالے / بشپړتيا / سازګاري / ناسازګاري / اعتبار» the clearest conventional rendering of “soundness / completeness / consistency / inconsistency / validity” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: سېکوېنټ / د سېکوېنټ حساب / طبيعي استنتاج / فرض / د فرض ختمول / تابلو / نښه لرونکے فارمول / بديهي اشتقاق / مودوس پوننس
- Why provisional: axiomatic proof and modus ponens attested; specialized calculus labels provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «سېکوېنټ / د سېکوېنټ حساب / طبيعي استنتاج / فرض / د فرض ختمول / تابلو / نښه لرونکے فارمول / بديهي اشتقاق / مودوس پوننس» the clearest conventional rendering of “sequent / sequent calculus / natural deduction / assumption / discharge / tableau / signed formula / axiomatic derivation / modus ponens” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
  - OLP-0063; fol; `content/first-order-logic/proof-systems/proof-systems.tex` source line(s) line pending; `ps-Arab-PK/content/first-order-logic/proof-systems/proof-systems.tex` target line(s) line pending; page: pending stable pagination in a reader containing this unit
...
- Choice: مقدم / تالي / لومړنے سېکوېنټ / منطقي قاعده / جوړښتي قاعده / اصلي عملګر
- Why provisional: sequent concept regionally supported by proof prose; specialized component labels provisional
...
- Choice: عمومي سور / وجودي سور / تړلې اصطلاح / ازاد متغير / تړلے متغير
- Why provisional: predicate and open-formula context regionally attested; exact quantifier compounds provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «عمومي سور / وجودي سور / تړلې اصطلاح / ازاد متغير / تړلے متغير» the clearest conventional rendering of “universal quantifier / existential quantifier / closed term / free variable / bound variable” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Choice: ځانګړے متغير / د ځانګړي متغير شرط / کمزوري کول / انقباض / تبادله / پرېکون
- Why provisional: inference-rule concepts supported; exact sequent-rule labels unattested and provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ځانګړے متغير / د ځانګړي متغير شرط / کمزوري کول / انقباض / تبادله / پرېکون» the clearest conventional rendering of “eigenvariable / eigenvariable condition / weakening / contraction / exchange / cut” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
  - OLP-0071; Propositional Rules; `content/first-order-logic/sequent-calculus/propositional-rules.tex` source line(s) line pending; `ps-Arab-PK/content/first-order-logic/sequent-calculus/propositional-rules.tex` target line(s) line pending; page: pending stable pagination in a reader containing this unit
...
- Why provisional: proof and conclusion language regionally supported; exact sequent-tree labels and backward-search compound provisional
...
- Why provisional: proof, consistency, satisfiability and relational concepts regionally supported; exact proof-theoretic and compactness compounds provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ثبوت-تيوريکي / انعکاسيت / يکنواختي / انتقاليت / د متناهي شاهد خاصيت / په متناهي ډول د صدق وړ / د متناهي شاهد قضيه» the clearest conventional rendering of “proof-theoretic / reflexivity / monotonicity / transitivity / compactness (finite witness) / finitely satisfiable / Compactness Theorem” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: semantic and proof roles regionally supported; exact multiword sequent-soundness compounds provisional
...
- Why provisional: proof-system and premise/conclusion roles regionally supported; exact natural-deduction and discharge compounds provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «فطري استنتاج / فرضيه / فرضيه ايستل / د داخلولو قاعده / د ايستلو قاعده / مقدمه / پايله» the clearest conventional rendering of “natural deduction / assumption / discharge / introduction rule / elimination rule / premise / conclusion” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: proof, truth, semantic and predicate roles regionally supported; exact tableau, signed-formula and branch compounds provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «تابلو / نښه لرونکے فارمول / د رښتياوالي نښه / څانګه / ريښه / تړلې او پرانيستې څانګه / پرېکون / د ځانګړي متغير شرط» the clearest conventional rendering of “tableau / signed formula / truth sign / branch / root / closed and open branch / cut / eigenvariable condition” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: general semantic, equality, relation, consistency, induction and proof concepts attested; exact construction and lemma labels unattested and provisional
...
- Why provisional: supporting axiom and proof concepts attested; exact metatheoretic labels unattested and provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د بديهي اصولو له لارې څرګندېدونکې / د پرېکړې وړ» the clearest conventional rendering of “axiomatizable / decidable” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: countability concepts regionally attested; theorem names and exact compounds provisional
...
- Why provisional: predicate, variable and formula contexts regionally attested; the grouped Pakistani terminology remains provisional
...
- Why provisional: mapping, value and satisfaction concepts supported; exact variable-assignment compounds are provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د متغير ګومارنه / بدله ګومارنه / د ترم قيمت / له ګومارنې خپلواکي» the clearest conventional rendering of “variable assignment / modified assignment / value of a term / assignment independence” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: induction and formula-generation concepts regionally supported; exact structural compounds are provisional
...
- Why provisional: theory, relation, order, entailment and countability concepts supported; model-theoretic compounds are provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «مدل / تيوري / مدل تيوري / بديهي طريقه / ځانګړې کول / مخکښ‌مرتبه» the clearest conventional rendering of “model / theory / model theory / axiomatic method / characterize / preorder” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: supporting logic, predicate, relation and semantic concepts regionally attested; exact hierarchy labels unattested and provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د ډېرو ډولونو منطق / د دويمې درجې منطق / د لوړې درجې منطق» the clearest conventional rendering of “many-sorted logic / second-order logic / higher-order logic” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
  - OLP-0174; fol; `content/first-order-logic/beyond/beyond.tex` source line(s) line pending; `ps-Arab-PK/content/first-order-logic/beyond/beyond.tex` target line(s) line pending; page: pending stable pagination in a reader containing this unit
...
- Why provisional: supporting axiom, relation and semantics concepts regionally attested; exact second-order compounds unattested and provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د ادراک شېما / وړاندوينيز او ناوړاندوينيز / بشپړه او کمزورې د دويمې درجې معنٰی پوهنه / قطعي» the clearest conventional rendering of “comprehension schema / predicative and impredicative / full and weak second-order semantics / categorical” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: supporting function, formula and induction concepts regionally attested; exact type-theoretic labels unattested and provisional
...
- Why provisional: supporting proof, proposition, semantics and induction concepts regionally attested; exact intuitionistic compounds and names unattested and provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «شهودي منطق / تعميري / د بي‌اېچ‌کې تفسير / دوه‌ګونې نفي ژباړه / د کرېپکي جوړښت او تحميل» the clearest conventional rendering of “intuitionistic logic / constructive / BHK interpretation / double-negation translation / Kripke structure and forcing” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
  - OLP-0174; fol; `content/first-order-logic/beyond/beyond.tex` source line(s) line pending; `ps-Arab-PK/content/first-order-logic/beyond/beyond.tex` target line(s) line pending; page: pending stable pagination in a reader containing this unit
...
- Why provisional: supporting proposition, relation and semantics concepts regionally attested; exact modal labels unattested and provisional
...
- Why provisional: structure, theory, interpretation, relation and function concepts supported by regional sources; exact model-theoretic compounds and the automorphism label are provisional
...
- Why provisional: partial, relation, quantifier and induction concepts supported by regional sources; exact back-and-forth and quantifier-rank compounds are provisional
...
- Why provisional: finite, infinite, model and compactness concepts supported by regional sources; exact overspill label is a provisional descriptive choice
...
- Why provisional: order, countability, relation and isomorphism concepts supported by regional sources; exact dense-order and theorem-name surfaces are provisional
...
- Why provisional: model, structure, domain, function, relation and countability concepts supported by regional sources; exact arithmetic-model compounds are provisional
...
- Why provisional: arithmetic, theory, proof and induction concepts supported by regional sources; eponym spellings and the exact true-arithmetic compound are provisional
...
- Why provisional: function, order, countability and induction roles supported by regional sources; exact nonstandard block vocabulary is provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «جانشين / مخکښېنی / بلاک / د نامعياري بلاکونو ګڼ ترتيب» the clearest conventional rendering of “successor / predecessor / block / dense ordering of non-standard blocks” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: function, relation, domain and countability concepts supported by regional sources; exact computability compounds and theorem name are provisional
...
- Why provisional: logic, sentence, semantic and proof concepts supported by regional sources; exact abstract-logic and normality labels are provisional
...
- Why provisional: semantic, predicate, relation and function roles supported by regional sources; exact property labels and expressive comparison are provisional
...
- Why provisional: compactness, countability, order and model concepts supported by regional sources; theorem name and exact property compounds are provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د ليندستروم قضيه / د متناهي شاهد خاصيت / د لوېنهايم--سکولم ښکته خاصيت / نامعياري پړاو» the clearest conventional rendering of “Lindstrom's theorem / Compactness Property / Downward Lowenheim--Skolem Property / nonstandard stage” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: zero, successor, projection, substitution and recursion concepts are directly supported by a regional source; the computability abstract noun and model compound remain provisional
...
- Why provisional: recursion, zero, successor and induction pattern directly supported by regional sources; the exact primitive-recursion compound and equation labels remain provisional
...
- Why provisional: zero and projection functions and multi-place operations are directly supported by a regional source; projection loanword, characteristic-function compound and arity label remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «پروجکشن تابع / ځانګړونکې تابع / ځاييزه کچه / صفر تابع» the clearest conventional rendering of “projection function / characteristic function / arity / zero function” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: function and induction concepts are directly supported by regional sources; the exact bounded-search compounds remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «محدوده کمينه‌موندنه / محدوده پلټنه / تر ټولو وړوکے شاهد» the clearest conventional rendering of “bounded minimization / bounded search / least witness” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: sequence, pairing, power and function concepts are directly supported by regional sources; the grouped coding and concatenation labels remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «اوليه عدد / عامل / فاکتوريل / د لړۍ کوډ / نښلول / غړے / اوږدوالی» the clearest conventional rendering of “prime / factor / factorial / sequence code / concatenate / element / length” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: recursion and sequence concepts are directly supported by regional sources; the three exact variant labels remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «هممهاله بازګښت / د ارزښتونو د بهير بازګښت / د پاراميټرونو بدلېدونکی بازګښت» the clearest conventional rendering of “simultaneous recursion / course-of-values recursion / parameter-changing recursion” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: the diagonal construction is directly supported by a regional source; the proper-name compound and negated class label remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «قطرول / د اکرمن--پېټر تابع / نابنسټيزه بازګشتي» the clearest conventional rendering of “diagonalization / Ackermann-Peter function / non-primitive-recursive” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: function and domain concepts are directly supported by regional sources; the exact partial-computability and unbounded-search compounds remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «جزوي محاسبه کېدونکې / جزوي بازګشتي / بې‌حده پلټنه / نۀ درېدل» the clearest conventional rendering of “partial computable / partial recursive / unbounded search / divergence” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: function, enumeration, pairing and sequence concepts are supported by regional sources; the exact normal-form and universal-function labels remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د نورمال شکل قضيه / شاخص / د محاسبې لړۍ / نړيواله جزوي تابع» the clearest conventional rendering of “normal form theorem / index / computation sequence / universal partial function” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: diagonal construction and function concepts are directly supported by regional sources; the exact halting labels remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د درېدنې مسئله / د درېدنې تابع / محاسبه کېدونکې نۀ» the clearest conventional rendering of “halting problem / halting function / noncomputable” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: recursion and function concepts are supported by regional sources; the historic class, regularity and Church-thesis labels remain provisional
...
- Why provisional: function, input and coding concepts are supported by regional sources; the exact s-m-n and parameterization labels remain provisional
...
- Why provisional: function and diagonal-sequence concepts are supported by regional sources; the exact computability compounds remain provisional
...
- Why provisional: set, function, relation and countability concepts are supported by regional sources; the exact computability labels remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «محاسبه کېدونکے سټ / محاسبه کېدونکې اړيکه / ځانګړونکې تابع / د پرېکړې وړ سټ» the clearest conventional rendering of “computable set / computable relation / characteristic function / decidable set” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: range and countability concepts are supported by regional sources; the exact effective-enumerability and semi-decidability compounds remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «په محاسبوي ډول د شمېر وړ / په بازګشتي ډول د شمېر وړ / د قيمتونو سټ / نيمه د پرېکړې وړ» the clearest conventional rendering of “computably enumerable / recursively enumerable / c.e. / range / semi-decidable” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: set, function, countability and diagonal reasoning have regional support and Pakistani prose governs register; the exact Rice-theorem and semantic-property compounds remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د رايس قضيه / شاخصي سټ / غيرابتذالي معنايي خاصيت / د پروګرام چلند» the clearest conventional rendering of “Rice's theorem / index set / nontrivial semantic property / program behavior” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: function, recursion and diagonal constructions have regional support and Pakistani prose governs syntax; the exact computability-theoretic fixed-point and self-reference labels remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د ثابت ټکي قضيه / ثابت ټکے / ځان-مراجعه / قطري تابع / ځان-چاپوونکی پروګرام» the clearest conventional rendering of “fixed-point theorem / fixed point / self-reference / diagonal function / self-printing program” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: Pakistani prose and regional function witnesses support register and functional exposition, but no inspected witness attests the exact Turing-machine component labels; all compact technical renderings remain reversible and provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ټيورينګ ماشين / پټه / مربع / لوست-ليک سر / الفبا / حالت / د حالت بدلون تابع» the clearest conventional rendering of “Turing machine / tape / square / read-write head / alphabet / state / transition function” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: Pakistani prose governs sentence shape and regional mathematical diagrams and functions provide comparator context; the exact automata labels are unattested in the inspected canon and remain provisional
...
- Why provisional: Pakistani prose, function and sequence witnesses govern exposition; the compact Turing-computation labels are unattested in the inspected canon and remain reversible and provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «لومړنی تشکيل / يوځاے کول / په يوه ګام کښې ورکول / چلونه / وت» the clearest conventional rendering of “initial configuration / concatenation / yields in one step / run / output” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: natural-number, parity, equality and function language has regional support and Pakistani prose governs register; the exact unary-machine compounds remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «يوګونې څرګندونه / حسابي تابع / جزوي محاسبه / لېږدوونکے» the clearest conventional rendering of “unary representation / arithmetic function / partial computation / mover” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: Pakistani prose and regional function/relation witnesses support syntax and role distinctions; the exact automata compounds remain provisional
...
- Why provisional: relation, function and parity witnesses support the mathematical contrasts while Pakistani prose governs register; the exact machine-variant labels remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «ناتعييني ټيورينګ ماشين / د حالت بدلون اړيکه / څو پټې / دوه-لوري نامتناهي پټه / تقليد» the clearest conventional rendering of “nondeterministic Turing machine / transition relation / multiple tapes / two-way infinite tape / simulation” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: the prior Church's-thesis decision supports اصل and regional function/composition witnesses support extensional equivalence; the full compound remains provisional
...
- Why provisional: proof, consistency and induction concepts are regionally supported and Pakistani prose controls register; the exact historical and metamathematical compounds remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «د ناتکميلۍ قضيه / د هېلبرټ پروګرام / صوري کول / متناهي‌پاله لار / د ثبوتونو تيوري» the clearest conventional rendering of “incompleteness theorem / Hilbert's program / formalization / finitary method / proof theory” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
  - OLP-0274; incompleteness; `content/incompleteness/incompleteness.tex` source line(s) 10; `ps-Arab-PK/content/incompleteness/incompleteness.tex` target line(s) line pending; page: pending stable pagination in a reader containing this unit
  - OLP-0275; inc; `content/incompleteness/introduction/introduction.tex` source line(s) line pending; `ps-Arab-PK/content/incompleteness/introduction/introduction.tex` target line(s) line pending; page: pending stable pagination in a reader containing this unit
...
- Why provisional: function, relation, coding, proof, consistency and arithmetic roles are supported by regional sources; the exact metamathematical compounds remain provisional
...
- Why provisional: sentence, theorem, consistency, arithmetic and diagonal reasoning have regional support; the exact incompleteness labels and eponym spellings remain provisional
...
- Please double-check: In Pakistani Pashto mathematical prose, is «خپلواکه جمله / د ګوډل جمله / د ناتکميلۍ لومړۍ او دويمه قضيه / د پرېسبورګر حساب» the clearest conventional rendering of “independent sentence / Gödel sentence / first and second incompleteness theorems / Presburger arithmetic” while preserving the distinctions in the rationale? If not, what exact replacement and inflected forms should be used?
- Locations:
...
- Why provisional: coding, sequence, countability, formation and arithmetic concepts have regional support; the exact Gödel-coding compounds remain provisional
...
- Why provisional: variable, formula, operation and recursive-test roles are regionally supported; the exact free-for and syntactic-predicate compounds remain provisional
...
- Why provisional: derivation, proof, sequent, assumption, consistency and coding roles are regionally supported; the exact arithmetization compounds remain provisional
...
- Choice: Preserve I and explain that context suggests identity on natural numbers; do not silently replace the source symbol.
- Why provisional: The inferred referent is strong but the source does not bind it.
...
- Please double-check: Does the note explain the inference without presenting it as an explicit source definition?
- Locations:
...
- Source term or sense: notation ambiguity
- Choice: Preserve X and explain that context suggests A, the ambient tree set.
- Why provisional: The contextual repair is strong but source text is genuinely inconsistent.
...
- Please double-check: Should a future edition correct X in the body or retain the current transparent note?
- Locations:
...
- Choice: Preserve both local definitions: reflexive closure in orders and transitive closure in operations; explain the overload.
- Why provisional: No formula uncertainty; usability risk comes from overloaded notation.
...
- Please double-check: Is the Pashto reader note prominent enough to prevent readers from transferring the wrong local definition?
- Locations:
...
- Choice: Translate both editorial blocks and all alternatives; later full-reader integration must label alternatives without presenting duplicate sequential doctrine.
- Why provisional: Integration is pending because the chapter is only partly translated.
...
- Please double-check: What Pashto heading best signals that the later sections are alternative presentations rather than additional cumulative requirements?
- Locations:
...
- Choice: Follow OpenLogic: g circle f means first f then g. The native comparator writes f circle g for the same evaluation, so it informs words only, never formula order.
- Why provisional: Mathematics is fixed; review concerns whether prose prevents convention transfer.
...
- Please double-check: Does the Pashto prose make the OpenLogic order unmistakable to readers familiar with the comparator convention?
- Locations:
...
- Choice: Preserve the source table while recording that its final row omits the displayed f(7) value -3 before the ellipsis. Add a reader note when this chapter enters the reader.
- Why provisional: Draft is structurally checked but not yet in a visually accepted reader.
...
- Please double-check: Should the eventual body show the corrected -3 entry with an adjacent stable source note?
- Locations:
