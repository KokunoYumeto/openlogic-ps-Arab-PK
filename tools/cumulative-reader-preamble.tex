...
\hypersetup{
  pdftitle={OpenLogic Pashto Pakistan - Cumulative Reader through Computability and Introductory Turing Machines},
  pdfauthor={Open Logic Project; independent Pashto (Pakistan) machine translation},
  pdfsubject={Work in progress: 255 of 722 source units}
}
...
\fancyhead[LE,RO]{\small له بنسټونو تر محاسبويت}
\fancyfoot[C]{\thepage}
...
{\LARGE له بنسټونو تر محاسبويت او د ټيورينګ ماشينونو پېژندګلو}\par\bigskip
د ماشيني ژباړې د روان کار ټوليزه نسخه
\end{center}
\bigskip
په دې ټوليزه لوستيزه نسخه کښې له OLP-0001 څخه تر OLP-0255 پورې
...
منطق، د ثبوت نظامونه، موډل نظريه، محاسبويت، او د ټيورينګ ماشينونو
لومړنۍ پېژندګلو رانغاړي۔ د ۷۲۲ واحدونو بشپړه ژباړه لا روانه ده۔
...
through OLP-0255). It uses the frozen upstream default profile: first-order
