...
\newcommand{\olasset}[2][\olphotowidth]{\centering\begin{LTR}\centering\resizebox{#1}{!}{\input{../upstream/#2}}\end{LTR}}
...
This reader contains the complete sets, relations and functions chapters (23 source
units). The source bundle also includes additional front matter, import drivers
and sections under translation: 73 of 722 source units in total.
...
تابعو يو بل عمل ترکيب دے: موږ}{موږ} دوه تابعې، \LR{$f$} او~\LR{$g$}، سره
...
عدد \LR{$n$} نوموي، خو بيا د هغه پر ځاے \LR{$x$} کاروي۔ ژباړه د هماغه
...
يو \LR{$a \in A$} ټاکل کېږي۔ دا ګام د \LR{$A$} ناتش والے غواړي۔ که
\LR{$A=\varnothing$} او \LR{$B\ne\varnothing$} وي، تشه تابع له \LR{$A$} څخه \LR{$B$}
ته يو پر يو ده، خو له \LR{$B$} څخه تش سټ ته تابع نشته، نو کيڼ معکوس
...
يوه يو پر يو تابع هله کيڼ معکوس لري چې \LR{$A\ne\varnothing$} وي يا
\LR{$B=\varnothing$} وي (OLFUN-001)۔

په \olref[sfr][fun][rel]{sec} کښې انګرېزي سرچينه د تابعې ګراف
«پر \LR{$A\times B$} اړيکه» بولي۔ د همدې کتاب د تعريف له مخې، کره خبره
دا ده چې دا د \LR{$A$} او \LR{$B$} ترمنځ اړيکه، يعنې د \LR{$A\times B$} فرعي
سټ، دے۔ ژباړه همدا کره عبارت کاروي (OLFUN-004)۔

په \olref[sfr][rel][ops]{sec} کښې تر \LR{$C$} پورې د اړيکې محدودونه
دواړه مختصات په \LR{$C$} کښې غواړي؛ خو په \olref[sfr][fun][rel]{sec}
کښې تر \LR{$C$} پورې د تابعې محدودونه يوازې ننوت په \LR{$C$} کښې غواړي۔
نو دا دوه تعريفونه په عمومي ډول يو شان نۀ دي۔ د بېلګې په توګه،
که \LR{$f(0)=1$} او \LR{$C=\{0\}$} وي، نو د تابعې محدودونه جوړه
\LR{$\tuple{0,1}$} ساتي؛ د اړيکې هغه محدودونه ئې نۀ ساتي۔ هر تعريف
